...
For these lessons, you will need to download a set of files which emulates the home filesystem of a user named Nelle.  Issue the following commands to download and change into nelle's home directory:
